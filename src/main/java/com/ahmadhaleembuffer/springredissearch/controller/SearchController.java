package com.ahmadhaleembuffer.springredissearch.controller;
...
import com.ahmadhaleembuffer.springredissearch.service.PostService;
...
public class SearchController {
    ...
    @GetMapping("/search")
    public Page search(@RequestParam(name = "content", required = false) String content, @RequestParam(name = "tags", required = false) Set<String> tags,
